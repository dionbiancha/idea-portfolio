        ...
        <div className="grid grid-rows-2 mt-6 lg:grid-cols-3 lg:grid-rows-1">
          ...
          <div className="mx-auto mt-6 lg:mr-0 lg:ml-auto lg:mt-0">
            <Animated.FromDirection from="bottom" animate={controls} custom={1} delay={1}>
              <RoundedButton as="a" href="https://www.canva.com/design/DAECvgtn3vo/S6b3joVEiUCYs_raR6naNQ/view?utm_content=DAECvgtn3vo&utm_campaign=designshare&utm_medium=link&utm_source=homepage_design_menu">
                {language.value === 'en' ? 'Download' : 'Download'} CV
              </RoundedButton>
            </Animated.FromDirection>
          </div>
        </div>
