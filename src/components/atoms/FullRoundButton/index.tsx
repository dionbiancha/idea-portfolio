...
export default function FullRoundButton({
  ...
  const classes = classNames(
    'flex items-center justify-center w-12 h-12 rounded-full focus:outline-none focus:ring-2 ring-green-500 ring-offset-2',
    className,
    {
      ...
      'bg-green-500 hover:bg-green-600 text-white': !active,
      'bg-white text-green-600': active
    }
  );
