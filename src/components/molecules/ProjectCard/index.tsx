  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <a className="font-medium text-yellow-400 rounded-lg hover:text-yellow-500 focus:outline-none focus:ring-2 ring-green-500 ring-offset-2 focus:text-green-500" href={url}>
          {language.value === 'en' ? 'Details' : 'Detalhes'}
        </a>
      </div>
    </article>
  );
