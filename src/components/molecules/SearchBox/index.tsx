...
export default function SearchBox({ className }: TextBoxProps) {
  ...
  return (
    <div
      className={classNames('focus-within:ring-2 ring-green-500 focus-within:shadow-xl focus-within:bg-white transition-all transform focus-within:scale-110 flex items-center overflow-hidden bg-gray-200 rounded-xl', className)}
    >
      <svg
